# Terraform Outputs for MDCA Demo Infrastructure
...
output "ssh_connection_command" {
  ...
  value       = "ssh -i C:/Users/User/.ssh/mdca-demo-ub24-${local.suffix}_key.pem lorenzoadm@${azurerm_public_ip.mdca_demo.ip_address}"
}

output "ssh_config_file" {
  description = "Location of generated SSH config file"
  value       = "C:/Users/User/.ssh/mdca-demo-config-${local.suffix}"
}

output "ssh_private_key_file" {
  description = "Location of SSH private key file"
  value       = "C:/Users/User/.ssh/mdca-demo-ub24-${local.suffix}_key.pem"
}
...
output "next_steps" {
  ...
  value = <<-EOT
    1. SSH to VM: ssh -i C:/Users/User/.ssh/mdca-demo-ub24-${local.suffix}_key.pem lorenzoadm@${azurerm_public_ip.mdca_demo.ip_address}
    ...
    7. VS Code: Use SSH config at C:/Users/User/.ssh/mdca-demo-config-${local.suffix}
  EOT
}
